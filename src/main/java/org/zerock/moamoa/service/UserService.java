...
public class UserService {
	...
	public User findById(Long id) {
		return userRepository.findById(id).orElseThrow(() -> new EntityNotFoundException(ErrorCode.USER_NOT_FOUND));
	}
	...
	@Transactional
	public User saveUser(String logintype, String token, String name, String nick, String profImg, String email,
